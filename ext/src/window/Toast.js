...
Ext.define('Ext.window.Toast', {
    ...
    /**
     * @inheritdoc Ext.window.Window#cfg-cls
     */
    cls: Ext.baseCSSPrefix + 'toast',

    /**
     * @inheritdoc Ext.window.Window#cfg-bodyPadding
     */
    bodyPadding: 10,
    ...
    /**
     * @inheritdoc Ext.window.Window#cfg-plain
     */
    plain: false,

    /**
     * @inheritdoc Ext.window.Window#cfg-draggable
     */
    draggable: false,

    /**
     * @inheritdoc Ext.window.Window#cfg-resizable
     */
    resizable: false,

    /**
     * @inheritdoc Ext.window.Window#cfg-shadow
     */
    ...
    /**
     * @inheritdoc Ext.window.Window#cfg-closable
     */
    closable: false,
