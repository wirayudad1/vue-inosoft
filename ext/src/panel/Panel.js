...
Ext.define('Ext.panel.Panel', {
    ...
    /**
     * Parses the {@link #cfg!bodyStyle} config if available to create a style string that will be applied to the body element.
     * This also includes {@link #cfg!bodyPadding} and {@link #cfg!bodyBorder} if available.
