...
Ext.define('Ext.Component', {
    ...
    config: {
        /**
         * @cfg {Object} data
         * The initial set of data to apply to the `{@link #cfg!tpl}` to update the content
     ...
     *
     * After being shown, a {@link #cfg!floating} Component (such as a {@link Ext.window.Window}), is activated
     * it and brought to the front of its {@link #zIndexManager z-index stack}.
     *
     * @param {String/Ext.dom.Element} [animateTarget=null] The target from which the Component should animate
     * from while opening. **only valid for {@link #cfg!floating} Components such as
     * {@link Ext.window.Window Windows} or {@link Ext.tip.ToolTip ToolTips}, or regular Components which
     * have been configured with `floating: true`.**
    ...
    deprecated: {
        5: {
            methods: {
                 ...
                 * @return {Ext.Component} this
                 * @deprecated 4.1 Use {@link #method!updateLayout} instead.
                 */
                 ...
                 * @inheritdoc Ext.Component#method!updateLayout
                 * @deprecated 4.1 Use {@link #method!updateLayout} instead.
                 */
