 ...
 * `{@link Ext.app.bind.Binding}` class. For convenience, a direct bind may be negated, 
 * which coerces the value to a boolean, however it may not be used as a two-way binding.
 *
 *      bind: {
 *          checked: '{!disabled}'
 *      }
 ...
 * ### Model Links
 *
 * A model can be described declaratively using a {@link #links}. In the example code below,
